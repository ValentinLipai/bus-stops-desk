...
## User stories
1. As a user I can open the url `http://localhost:8080` and see entry page with listed lines (https://www.figma.com/file/iOqjfJUOtINstwsCu3mhEX/Bus-stop-Time-table?type=design&node-id=1%3A3)
   ...
   5. User can click at line
      1. Placeholder disappear and user can see listed stops. Stops should be sorted ascending by field `order` from the api (https://www.figma.com/file/iOqjfJUOtINstwsCu3mhEX/Bus-stop-Time-table?type=design&node-id=701-27993)
   ...
   6. User can click at stop when line is selected
      ...
      2. User can see listed hours for the selected stop sorted (https://www.figma.com/file/iOqjfJUOtINstwsCu3mhEX/Bus-stop-Time-table?type=design&node-id=701-36989) 

2. As a user I can open the url `http://localhost:8080/stops` and see "stops" page with listed stops (https://www.figma.com/file/iOqjfJUOtINstwsCu3mhEX/Bus-stop-Time-table?type=design&node-id=701-38100)
   1. User can see title "Stops board"
